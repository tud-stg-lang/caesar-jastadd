...
public class GraphSorter {
	 ...
	 *  deriving a subclass and implementing the calcOutgoingNodes() method
	 */
	abstract static public class Node {
		 ...
		 */
		public void sort(List<Node> sortedLst) throws CycleFoundException {
			if (!sorted) {
	 ...
	 */
	public List<Node> getSortedNodes() throws CycleFoundException {
		if (sortedNodes == null) {
